...
#define ADXL345_FIFO_BYPASS     0x0         // put ADXL FIFO into bypass mode
#define ADXL345_FIFO_FIFO       0x1         // put ADXL FIFO into FIFO mode
#define ADXL345_FIFO_STREAM     0x2         // put ADXL FIFO into stream mode
#define ADXL345_FIFO_TRIGGER    0x3         // put ADXL FIFO into trigger mode
#define ADXL345_FIFO_INT1       0x0         // use INT1 for trigger mode
#define ADXL345_FIFO_INT2       0x1         // use INT2 for trigger mode
...
public:
    ...
    void setFifoMode(int mode, int samples, int trigger_int);
    int getFifoMode();
    int getFifoStatusSampleCount();
